...
`{cscb.tools}` is a set of helper wrapper functions designed to work with a Seurat-based approach to single-cell analysis. The standard workflow for CSCB's Seurat-based preprocessing steps are as follows:
